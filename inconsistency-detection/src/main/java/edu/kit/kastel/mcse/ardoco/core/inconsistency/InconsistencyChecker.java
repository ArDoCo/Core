...
public class InconsistencyChecker extends AbstractExecutionStage {
	...
	private MutableList<InconsistencyAgent> agents = Lists.mutable.of(new InitialInconsistencyAgent(), new MissingModelElementInconsistencyAgent(), new MissingTextForModelElementInconsistencyAgent());
