...
public interface IRecommendationState extends ICopyable<IRecommendationState>, IConfigurable {
	 ...
	 */
	IRecommendedInstance addRecommendedInstance(String name, String type, double probability, ImmutableList<INounMapping> nameMappings, ImmutableList<INounMapping> typeMappings);
