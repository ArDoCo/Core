...
public final class NounMappingFactory {
     ...
     */
    public static INounMapping createMappingTypeNode(IWord n, String reference, MappingKind kind, double probability,
     ...
     */
    public static INounMapping createNameNode(List<IWord> nodes, double probability, String name,
            List<String> occurrences) {
     ...
     * @return the created name mapping
     */
    public static INounMapping createNameMapping(IWord node, double probability, String type,
            List<String> occurrences) {
     ...
     */
    public static INounMapping createTypeMapping(IWord node, double probability, String type,
            List<String> occurrences) {
     ...
     * @return the created type mapping
     */
    public static INounMapping createTypeNode(List<IWord> nodes, double probability, String type,
            List<String> occurrences) {
     ...
     */
    public static INounMapping createNortMapping(IWord node, double probability, String type,
            List<String> occurrences) {
     ...
     * @return the created name or type mapping
     */
    public static INounMapping createNortNode(List<IWord> nodes, double probability, String ref,
            List<String> occurrences) {
