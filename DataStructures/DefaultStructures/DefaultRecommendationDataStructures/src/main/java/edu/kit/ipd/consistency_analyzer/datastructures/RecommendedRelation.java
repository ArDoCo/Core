...
public class RecommendedRelation implements IRecommendedRelation {
	 ...
	 */
	public RecommendedRelation(String name, IRecommendedInstance instance0, IRecommendedInstance instance1, List<IRecommendedInstance> otherInstances, double probability, List<IWord> nodes) {
