 ...
 */
@Deterministic public class Swap<B, E> extends Inconsistency<B, E> {
            ...
            for (var second : nameInconsistencies) {
                ...
                if (firstExpectedName.equals(secondActualName)) {
                    newInconsistencies.add(
                            new Swap<>(first.getBox(), first.getEntity(), second.getBox(), secondExpectedName));
    ...
    public <R, M> Inconsistency<R, M> map(Function<B, R> boxMapper, Function<E, M> entityMapper) {
        return new Swap<>(boxMapper.apply(this.getBox()), entityMapper.apply(this.getEntity()),
                boxMapper.apply(this.otherBox), this.otherExpectedName);
    }
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(this.otherBox, casing.otherBox) && Objects.equals(this.otherExpectedName,
                casing.otherExpectedName);
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("otherBox", this.otherBox)
                .append("otherExpectedName", this.otherExpectedName)
                .toString();
    }
}
