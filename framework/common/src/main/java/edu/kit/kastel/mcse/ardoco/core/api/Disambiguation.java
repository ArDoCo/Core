...
public class Disambiguation implements Serializable {
  ...
  public static class DisambiguationSerializer extends JsonSerializer<Disambiguation> {
    @Override
    public void serialize(Disambiguation abbreviation, JsonGenerator jsonGenerator,
  ...
  @JsonCreator
  public Disambiguation(@JsonProperty("abbreviation") @NotNull String abbreviation,
                        @JsonProperty("meanings") @NotNull String[] meanings) {
  ...
  public static ImmutableMap<String, Disambiguation> toMap(List<Disambiguation> disambiguations) {
    ...
    for (var disambiguation : disambiguations) {
      map.merge(disambiguation.getAbbreviation(), disambiguation,
              Disambiguation::addMeanings);
    }
