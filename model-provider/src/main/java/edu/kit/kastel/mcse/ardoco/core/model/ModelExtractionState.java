...
public class ModelExtractionState extends AbstractState implements IModelState {
	...
	private ModelExtractionState(String modelId, Metamodel metamodelType, Set<String> instanceTypes, Set<String> relationTypes, Set<String> names, ImmutableList<IModelInstance> instances,
			ImmutableList<IModelRelation> relations, Map<String, String> configs) {
		super(configs);
	 ...
	 */
	public ModelExtractionState(String modelId, Metamodel metamodelType, ImmutableList<IModelInstance> instances, ImmutableList<IModelRelation> relations, Map<String, String> configs) {
		super(configs);
