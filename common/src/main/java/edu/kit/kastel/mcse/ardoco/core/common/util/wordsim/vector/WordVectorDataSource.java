...
public interface WordVectorDataSource {
	 ...
	 *
	 * @param word the word
	 * @return the vector representation of that word, or {@link Optional#empty()}
	 * if no vector representation for the given word exists
	 * @throws RetrieveVectorException if an error occurs while trying to
	 *                                 retrieve the vector
	 */
