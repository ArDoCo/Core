...
import edu.kit.kastel.mcse.ardoco.core.tests_new.integration.tlrhelper.files.TLGoldStandardFile;
 ...
 */
public class TLProjectEvalResult implements Comparable<TLProjectEvalResult> {
