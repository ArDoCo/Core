...
public enum Project {
    MEDIASTORE(//
            ...
            new ExpectedResults(.000, .000, .256, .248, .178) //
    ), //
    TEAMMATES( //
            ...
            new ExpectedResults(.000, .000, .222, .057, .227) //
    ), //
    TEASTORE( //
            ...
            new ExpectedResults(.000, .000, .250, .190, .103) //
    ), //
    BIGBLUEBUTTON( //
            ...
            new ExpectedResults(.000, .000, .272, .168, .190) //
    );
