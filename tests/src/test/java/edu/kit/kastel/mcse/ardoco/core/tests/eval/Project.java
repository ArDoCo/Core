...
public enum Project {
    ...
    BIGBLUEBUTTON( //
            ...
            "src/test/resources/diagrams/bbb", new ExpectedResults(.877, .826, .850, .984, .843, .993), //
    ...
    JABREF_HISTORICAL( //
            ...
            null, new ExpectedResults(.817, .999, .899, .966, .886, .960), //
    ...
    Project(String model, String textFile, String goldStandardTraceabilityLinkRecovery, String configurationsFile,
            String goldStandardMissingTextForModelElement, String diagramDir, ExpectedResults expectedTraceLinkResults,
