...
public class DummyObjects {
  ...
  public static final TraceLinkGS DUMMY_TRACE_LINK_GS = new TraceLinkGS("SomeName", new int[]{0,
          42, 404},
          new TypedTraceLinkGS[]{new TypedTraceLinkGS(new int[]{3, 7, 11},
                  TraceType.ENTITY_COREFERENCE)});
}
