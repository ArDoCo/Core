...
public class ArchitectureTest {
    ...
    public static final ArchRule modelInstancesOnlyAfterModelExtraction = classes().that()
                                                                                   ...
                                                                                   .should()
                                                                                   .onlyHaveDependentClassesThat()
                                                                                   .resideInAnyPackage("..models..", "..connectiongenerator..",
                                                                                           "..inconsistency..", "..pipeline..", "..common..", "..output..",
                                                                                           "..tests..");
    ...
    public static final ArchRule linksOnlyAfterConnectionGenerator = classes().that()
                                                                              ...
                                                                              .should()
                                                                              .onlyHaveDependentClassesThat()
                                                                              .resideInAnyPackage("..connectiongenerator..", "..codetraceability..",
                                                                                      "..tracelinks..", "..inconsistency..", "..pipeline..", "..common..",
                                                                                      "..api..", "..tests..");
    ...
    public static final ArchRule usingLinkAsNamingOnlyInConnectionGenerator = classes().that()
                                                                                       .haveSimpleNameEndingWith("Link")
                                                                                       .should()
                                                                                       .resideInAnyPackage("..models.tracelinks..", "..connectiongenerator..",
                                                                                               "..output..", "..tests..");
    ...
    public static final ArchRule inconsistencyOnlyAfterInconsistencyDetection = classes().that()
                                                                                         ...
                                                                                         .should()
                                                                                         .onlyHaveDependentClassesThat()
                                                                                         .resideInAnyPackage("..inconsistency..", "..execution..", "..api..",
                                                                                                 "..common..", "..tests..");
    ...
    public static final ArchRule layerRule = layeredArchitecture().consideringAllDependencies()
                                                                  ...
                                                                  .mayOnlyBeAccessedByLayers("CodeTraceability", "InconsistencyDetection", "Pipeline", "Common",
                                                                          "Execution")
                                                                  ...
                                                                  .mayOnlyBeAccessedByLayers("RecommendationGenerator", "ConnectionGenerator",
                                                                          "InconsistencyDetection", "Pipeline", "Common", "Execution")
                                                                  .whereLayer("ModelExtractor")
                                                                  .mayOnlyBeAccessedByLayers("RecommendationGenerator", "ConnectionGenerator",
                                                                          "CodeTraceability", "InconsistencyDetection", "Pipeline", "Common", "Execution");
}
