...
public class HardCodedModelInput {
	...
	private List<Triple<String, String, String>> loadInstances() {
		...
		Triple<String, String, String> i0 = new Triple<>("Common", "composite component", "i0");
		Triple<String, String, String> i1 = new Triple<>("Common Interface", "interface", "i1");
		Triple<String, String, String> i2 = new Triple<>("util", "basic component", "i2");
		Triple<String, String, String> i3 = new Triple<>("exception", "basic component", "i3");
		Triple<String, String, String> i4 = new Triple<>("datatransfer", "basic component", "i4");

		Triple<String, String, String> i5 = new Triple<>("UI", "composite component", "i5");
		Triple<String, String, String> i6 = new Triple<>("UI Interface", "interface", "i6");
		Triple<String, String, String> i7 = new Triple<>("automated", "basic component", "i7");
		Triple<String, String, String> i8 = new Triple<>("webapi", "basic component", "i8");
		Triple<String, String, String> i9 = new Triple<>("website", "basic component", "i9");
		Triple<String, String, String> i10 = new Triple<>("UI website Interface", "interface", "i10");

		Triple<String, String, String> i11 = new Triple<>("Logic", "composite component", "i11");
		Triple<String, String, String> i12 = new Triple<>("Logic Interface", "interface", "i12");
		Triple<String, String, String> i13 = new Triple<>("core", "basic component", "i13");
		Triple<String, String, String> i14 = new Triple<>("Logic core Interface", "interface", "i14");
		Triple<String, String, String> i15 = new Triple<>("api", "basic component", "i15");
		Triple<String, String, String> i16 = new Triple<>("Logic api Interface", "interface", "i16");

		Triple<String, String, String> i17 = new Triple<>("Storage", "composite component", "i17");
		Triple<String, String, String> i18 = new Triple<>("Storage api Interface", "interface", "i18");
		Triple<String, String, String> i19 = new Triple<>("Storage entity Interface", "interface", "i19");
		Triple<String, String, String> i20 = new Triple<>("entity", "basic component", "i20");
		Triple<String, String, String> i21 = new Triple<>("api", "basic component", "i21");
		Triple<String, String, String> i22 = new Triple<>("search", "basic component", "i22");
		Triple<String, String, String> i23 = new Triple<>("Storage search Interface", "interface", "i23");

		Triple<String, String, String> i24 = new Triple<>("Test Driver", "composite component", "i24");
		Triple<String, String, String> i25 = new Triple<>("driver", "basic component", "i25");
		Triple<String, String, String> i26 = new Triple<>("Test driver Interface", "interface", "i26");
		Triple<String, String, String> i27 = new Triple<>("cases", "basic component", "i27");

		Triple<String, String, String> i28 = new Triple<>("E2E", "composite component", "i28");
		Triple<String, String, String> i29 = new Triple<>("pageobjects", "basic component", "i29");
		Triple<String, String, String> i30 = new Triple<>("cases", "basic component", "i30");
		Triple<String, String, String> i31 = new Triple<>("util", "basic component", "i31");
		Triple<String, String, String> i32 = new Triple<>("E2E pageobjects Interface", "interface", "i32");
		Triple<String, String, String> i33 = new Triple<>("E2E util Interface", "interface", "i33");

		Triple<String, String, String> i34 = new Triple<>("Client", "composite component", "i34");
		Triple<String, String, String> i35 = new Triple<>("scripts", "basic component", "i35");
		Triple<String, String, String> i36 = new Triple<>("remoteapi", "basic component", "i36");
		Triple<String, String, String> i37 = new Triple<>("Client remoteapi Interface", "interface", "i37");

		Triple<String, String, String> i38 = new Triple<>("GAE Datastorage", "basic component", "i38");
		Triple<String, String, String> i39 = new Triple<>("GAE DataStore Interface", "Interface", "i39");

		List<Triple<String, String, String>> modelInstances = List.of(//
