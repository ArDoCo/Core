...
This repository contains modules to perform various inconsistency detection tasks with ArDoCo. For more information about the ArDoCo project visit the core website at [ArDoCo/Core](https://github.com/ArDoCo/Core).
