...
public class AddNounMappingsToTextStateTest {
	...
	void addTextualEqualNounMappingWithSimilarPhrase() {
		...
		Assertions.assertAll(
				...
				() -> Assertions.assertIterableEquals(preTextState.getNounMappingsByPhraseMapping(previousPhraseMapping), textState.getNounMappingsByPhraseMapping(extendedPhraseMapping)),
				() -> Assertions.assertEquals(1, textState.getNounMappingsByPhraseMapping(extendedPhraseMapping).size()),
				() -> Assertions.assertTrue(textState.getNounMappingsByPhraseMapping(extendedPhraseMapping).get(0).getPhrases().containsAll(List.of(dogPhrase0, dogPhrase1))));
	}
	...
	void addEqualNounMappingWithDifferentPhrase() {
		...
		Assertions.assertAll(//
				...
				() -> Assertions.assertNotEquals(preTextState.getPhraseMappings(), textState.getPhraseMappings()), () -> Assertions.assertTrue(fox2PhraseMapping.getPhrases().contains(foxPhrase1)),
	...
	void addSimilarNounMappingWithEqualPhrase() {
		...
		Assertions.assertAll(//
				() -> Assertions.assertTrue(!textState.getNounMappingsByWord(dog1).isEmpty()), () -> Assertions.assertTrue(textState.getNounMappingsByWord(alternativeDog).size() == 1),
	...
	void addSimilarNounMappingWithSimilarPhraseContainingSimilarNounMapping() {
		...
		Assertions.assertAll(//
				() -> Assertions.assertTrue(!textState.getNounMappingsByWord(doggy5).isEmpty()), () -> Assertions.assertTrue(textState.getNounMappingsByWord(doggy5).size() == 1),
		...
		Assertions.assertAll(//
				() -> Assertions.assertTrue(doggyNounMapping.getWords().contains(doggy5)), () -> Assertions.assertTrue(doggyNounMapping.getWords().contains(dog3)),
				() -> Assertions.assertTrue(doggyNounMapping.getPhrases().contains(dogPhrase1)), () -> Assertions.assertTrue(doggyNounMapping.getPhrases().contains(dogPhrase3)));

		var doggyPhraseMappings = textState.getPhraseMappingsByNounMapping(doggyNounMapping);

		Assertions.assertAll(//

				() -> Assertions.assertEquals(doggyPhraseMappings, textState.getPhraseMappingsByNounMapping(dogNounMapping)), () -> Assertions.assertTrue(doggyPhraseMappings.size() == 1),
				() -> Assertions.assertTrue(textState.getNounMappingsByPhraseMapping(doggyPhraseMappings.get(0)).contains(doggyNounMapping)),
				() -> Assertions.assertTrue(doggyPhraseMappings.get(0).getPhrases().contains(dogPhrase3)), () -> Assertions.assertTrue(doggyPhraseMappings.get(0).getPhrases().contains(dogPhrase1)));
	...
	void addDifferentNounMappingWithEqualPhrase() {
		...
		Assertions.assertAll(//
				...
				() -> Assertions.assertFalse(!textState.getNounMappingsByPhraseMapping(textState.getPhraseMappings().select(pm -> pm.getPhrases().contains(dogPhrase0)).get(0))
						.select(nm -> nm.getWords().contains(dog3)).isEmpty()),
				...
				() -> Assertions.assertTrue(textState.getNounMappingsByPhraseMapping(dog1PhraseMapping).select(nm -> nm.getWords().contains(hut3)).size() == 1));
	}
