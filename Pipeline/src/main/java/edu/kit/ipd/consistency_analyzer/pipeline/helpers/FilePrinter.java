...
public class FilePrinter {
		...
		try (FileWriter myWriter = new FileWriter(debugGraphSentences)) {
			...
			for (IInstanceLink il : instanceLinks) {
				...
				String instanceLinkString = modelInstance.getUid() + SINGLE_SEPARATOR_WITH_SPACES + modelInstance.getLongestName() + //
						SINGLE_SEPARATOR_WITH_SPACES + String.join(", ", modelInstance.getLongestType()) + SINGLE_SEPARATOR_WITH_SPACES + textualInstance.getName() + //
						SINGLE_SEPARATOR_WITH_SPACES + names.toString() + SINGLE_SEPARATOR_WITH_SPACES + textualInstance.getType() + SINGLE_SEPARATOR_WITH_SPACES + types.toString()
	...
	private static String createNameAndTypeMappingInfoString(String name, String type, double probability, List<String> nameMappingStrings, List<String> typeMappingStrings) {
