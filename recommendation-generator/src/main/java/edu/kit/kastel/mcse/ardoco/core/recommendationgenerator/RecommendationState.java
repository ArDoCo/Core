...
public class RecommendationState extends AbstractState implements IRecommendationState {
	 ...
	 */
	@Override
	public IRecommendedInstance addRecommendedInstance(String name, String type, double probability, ImmutableList<INounMapping> nameMappings, ImmutableList<INounMapping> typeMappings) {
		var recommendedInstance = new RecommendedInstance(name, type, probability, //
				Lists.immutable.withAll(new HashSet<>(nameMappings.castToCollection())), Lists.immutable.withAll(new HashSet<>(typeMappings.castToCollection())));
