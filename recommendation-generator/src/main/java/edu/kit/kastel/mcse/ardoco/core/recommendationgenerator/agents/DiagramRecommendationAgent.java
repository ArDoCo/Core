...
import edu.kit.kastel.mcse.ardoco.core.recommendationgenerator.informants.DiagramRecommendationInformant;
...
public class DiagramRecommendationAgent extends PipelineAgent {
    ...
    public DiagramRecommendationAgent(DataRepository dataRepository) {
        ...
        informants = List.of(new DiagramRecommendationInformant(dataRepository));
