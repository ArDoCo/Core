...
public class RecommendationGenerator extends AbstractExecutionStage {
	...
	private MutableList<RecommendationAgent> agents = Lists.mutable.of(new InitialRecommendationAgent(), new PhraseRecommendationAgent(), new InstanceRelationAgent());
