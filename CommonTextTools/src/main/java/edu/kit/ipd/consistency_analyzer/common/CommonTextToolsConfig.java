...
public class CommonTextToolsConfig {
	 ...
	 * lists.
	 */
	public static final double ARE_WORDS_OF_LISTS_SIMILAR_WORD_SIMILARITY_THRESHOLD = CONFIG.getPropertyAsDouble("areWordsOfListsSimilar_WordSimilarityThreshold");
