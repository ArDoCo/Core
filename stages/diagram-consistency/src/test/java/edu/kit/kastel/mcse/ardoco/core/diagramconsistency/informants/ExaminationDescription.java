...
record ExaminationDescription(DiagramProject project, GeneralModelType generalModelType, int refactoringIndex,
                              double epsilon, int maxAlgorithmIterations, double textSimilarityThreshold,
                              Refactoring<Box, ArchitectureItem> archPreRefactoring,
                              Refactoring<Box, CodeItem> codePreRefactoring) {
    ExaminationDescription withProject(DiagramProject project) {
        return new ExaminationDescription(project, this.generalModelType, this.refactoringIndex, this.epsilon,
