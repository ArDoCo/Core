...
class SyntheticDiagramsTest extends EvaluationBase {
    ...
    void refactorArchitectureModel(DiagramProject project) {
        RefactoringBundle<Box, ArchitectureItem> bundle = new RefactoringBundle<>(
                Map.of(new Connect<>(), 1, new Create<>(), 1, new Delete<>(), 1, new Disconnect<>(), 1, new Move<>(), 1,
                        new Rename<>(), 1));
    ...
    void refactorCodeModel(DiagramProject project) {
        RefactoringBundle<Box, CodeItem> bundle = new RefactoringBundle<>(
                Map.of(new Connect<>(), 2, new Create<>(), 2, new Delete<>(), 2, new Disconnect<>(), 2, new Move<>(), 2,
                        new Rename<>(), 2));
