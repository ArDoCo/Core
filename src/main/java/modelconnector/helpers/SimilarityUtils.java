...
public final class SimilarityUtils {
	 ...
	 */
	public static List<NounMapping> getAllSimilarNMappingToInstanceByReferences(Instance instance, List<NounMapping> mapping) {
	 ...
	 *         names)
	 */
	public static List<RecommendedInstance> getMostRecommendedInstancesToInstanceByReferences(Instance instance, List<RecommendedInstance> recommendedInstances) {
		List<String> instanceNames = instance.getNames();
