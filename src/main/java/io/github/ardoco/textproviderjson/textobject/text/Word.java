...
public interface Word extends Comparable<Word> {
     ...
     */
    ImmutableList<Word> getOutgoingDependencyWordsWithType(DependencyType dependencyTag);
     ...
     */
    ImmutableList<Word> getIncomingDependencyWordsWithType(DependencyType dependencyTag);
